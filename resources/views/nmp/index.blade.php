...
@section('tittle','List NMP Device')
@push('header-name')
<h1>
    NMP Device
<small>
    {{-- <a class="btn btn-success" href="{{route('NMP.create')}}"> Create New NMP</a> --}}
    <a href="{{route('export.nmp')}}"><button type="button" class="btn btn-success" >
...
<div class="box">
    ...
    <div class="box-body">
        <table id="NMP-table" class="table table-bordered" style="width:100%">
            <thead>
                <tr>
                    {{-- <th>Id</th> --}}
                    <th>Area</th>
               ...
               @foreach ($nmp as $item)
                   <tr>
                       ...
                       <td>
                            ...
                            <a href="{{route('nmp.edit',$item->id)}}" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                            {{-- <a href="" class="btn btn-xs btn-default btn-delete"><i class="glyphicon glyphicon-trash"></i> Delete</a> --}}
                            {{-- <div class="btn-group">
                            <form method="POST" action="{{route('NMP.destroy',$item->id)}}">
                                {{csrf_field()}}
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- {!! Form::model($device, ['method'=>'PATCH','route'=>['NMP.update',$device->id],'name' => 'formModalTransfer','id' => 'formModalTransfer']) !!} --}}
