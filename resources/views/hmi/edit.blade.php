...
@section('tittle','Show HMI Device')

@section('content')
<div class="box">
    <div class="box-header">
    <h3 class="box-tittle"> Edit HMI Device</h3>
    ...
    <div class="box-body">
        {!! Form::model($hmi, ['method'=>'PATCH','route'=>['hmi.update',$hmi->id]]) !!}
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {{-- {!! Form::select('machine_number', $machine,$HMI->id_machine, ['class' => 'form-control','id' =>'machine_number','placeholder'=> '','readonly']) !!} --}}
                    ...
                    <select name="model_type" id="model_type" class="form-control">
                        <option value="Null">Select Model</option>
                            @foreach ($model_type as $item)
                                <option value="{{$item->model_type}}" {{$item->model_type == $hmi->model_type ? 'selected':''}}>{{$item->model_type}}</option>
                            @endforeach
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('device_status_monitor', ['OK'=>'OK','Not OK' =>'Not OK','Not Installed' => 'Not Installed'], null, ['class' => 'form-control','style' => 'text-transform:uppercase','id'=>'device_status_monitor']) !!}
                </div>
                <div class="form-group">
