...
<small>
    ...
    <a href="{{route('export.scanner')}}"><button type="button" class="btn btn-success" >
...
<ol class="breadcrumb">
    ...
    <li class="active">Scanner Device</li>
</ol>
@endpush
@section('content')
<div class="box">
               ...
               @foreach ($scanner as $item)
                   <tr>
                       ...
                       <td>
                            ...
                            <a href="{{route('scanner.edit',$item->id)}}" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                            {{-- <a href="" class="btn btn-xs btn-default btn-delete"><i class="glyphicon glyphicon-trash"></i> Delete</a> --}}
                            {{-- <div class="btn-group">
                            <form method="POST" action="{{route('scanner.destroy',$item->id)}}">
                                {{csrf_field()}}
