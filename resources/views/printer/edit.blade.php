...
@section('tittle','Show Printer Device')

@section('content')
<div class="box">
    <div class="box-header">
    <h3 class="box-tittle"> Edit Printer Device</h3>
    ...
    <div class="box-body">
        {!! Form::model($printer, ['method'=>'PATCH','route'=>['printer.update',$printer->id]]) !!}
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {{-- {!! Form::select('machine_number', $machine,$printer->id_machine, ['class' => 'form-control','id' =>'machine_number','placeholder'=> '','readonly']) !!} --}}
                ...
                <div class="form-group">
                    ...
                    <select name="model_type" id="model_type" class="form-control">
                            ...
                            @foreach ($model_type as $item)
                                <option value="{{$item->model_type}}"  {{$item->model_type == $printer->model_type ? 'selected':''}}>{{$item->model_type}}</option>
                            @endforeach
