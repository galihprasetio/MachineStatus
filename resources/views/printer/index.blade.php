...
@section('tittle','List Printer Device')
@push('header-name')
<h1>
    Printer Device
<small>
    {{-- <a class="btn btn-success" href="{{route('printer.create')}}"> Create New Printer</a> --}}
    <a href="{{route('export.printer')}}">
...
<ol class="breadcrumb">
    ...
    <li class="active">Printer Device</li>
</ol>
@endpush
@section('content')
<div class="box">
    ...
    <div class="box-body">
        <table id="printer-table" class="table table-bordered" style="width:100%">
            <thead>
                <tr>
                    {{-- <th>Id</th> --}}
                    <th>Area</th>
               ...
               @foreach ($printer as $item)
                   <tr>
                       ...
                       <td>
                            ...
                            <a href="{{route('printer.edit',$item->id)}}" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                            {{-- <a href="" class="btn btn-xs btn-default btn-delete"><i class="glyphicon glyphicon-trash"></i> Delete</a> --}}
                            {{-- <div class="btn-group">
                            <form method="POST" action="{{route('printer.destroy',$item->id)}}">
                                {{csrf_field()}}
...
<div id="modalTransfer" class="modal fade" role="dialog">
    ...
    @push('script')
    <script>
    var table = $('#printer-table').DataTable({
        paging:   true,
        info:     true,
        searching: true,
        select: true, 
