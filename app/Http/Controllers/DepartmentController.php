...
class DepartmentController extends Controller
{
    ...
    //     $this->middleware('permission:department-edit',['only'=>['edit','upate']]);
    // }
    /**
    ...
    public function destroy($id)
    {
      ...
      // Assets::destroy($id);
       return redirect()->route('department.index')->with(['success' => 'Department deleted successfully', 'class' => 'close']);
